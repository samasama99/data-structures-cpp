...
struct redBlackTreeNode {
    ...
    redBlackTreeNode(key k, value v) : k(k), v(v){};

    redBlackTreeNode(key k, value v, Color c) : k(k), v(v), color(c){};

    redBlackTreeNode(key k, value v, node l, node r, node p, Color c = RED)
